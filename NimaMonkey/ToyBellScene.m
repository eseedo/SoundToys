...
@implementation ToyBellScene

+(CCScene*)scene{
    
    CCScene *scene = [CCScene node];
    ToyBellScene *layer = [ToyBellScene node];
...
-(void)addBell{
    ...
    bell = [CCSprite spriteWithFile:@"shakebell.png"];
...
-(void)playIntroMusic{
    ...
    [[SimpleAudioEngine sharedEngine]playEffect:@"shakebellintro.wav"];
}
